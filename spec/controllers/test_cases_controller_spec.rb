...
RSpec.describe TestCasesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: test_case.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      test_case = TestCase.create! valid_attributes
      get :edit, params: {id: test_case.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new TestCase" do
        expect {
          post :create, params: {test_case: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {test_case: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested test_case" do
        test_case = TestCase.create! valid_attributes
        put :update, params: {id: test_case.to_param, test_case: new_attributes}, session: valid_session
        test_case.reload
      ...
      it "redirects to the test_case" do
        test_case = TestCase.create! valid_attributes
        put :update, params: {id: test_case.to_param, test_case: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        test_case = TestCase.create! valid_attributes
        put :update, params: {id: test_case.to_param, test_case: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested test_case" do
      test_case = TestCase.create! valid_attributes
      expect {
        delete :destroy, params: {id: test_case.to_param}, session: valid_session
      }.to change(TestCase, :count).by(-1)
    end
